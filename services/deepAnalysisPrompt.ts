...
|----|------|------|------|--------|
| R02 | 见顶阶梯 | 对子顶/巨量见顶/第二波见顶/长上影/跳空衰竭/纺锤线/长下影见顶/涨停封板/涨停炸板/巨量异动，按严重度择优，extraData列全部命中子信号 | CRITICAL | A |
| R04 | 离场阶梯 | 急跌/5/13死叉/5/10死叉/破趋势线+破MA60/有效跌破10日线/放量离场/跌破5日线/破趋势线/MA5拐头/跌破10日线待确认/缩量破位，按严重度择优，extraData列全部命中子信号 | CRITICAL | A |
...
| R12 | RSI超卖 | RSI(6)<20超卖，强下行趋势(MA20下行+破MA20)中过滤 | INFO | A |
...
| R17 | 站稳五日线加仓 | 连续3日收盘站上MA5+MA5上行+站稳刚形成 | INFO | B |
| R18 | 筹码低位密集 | 90%集中度<0.18+获利盘>60%+主峰≤现价×1.03，结构偏多（换手率转移模型，参考级，不计入共振）| INFO | B |
| R19 | 筹码高位套牢 | 获利盘<40%+主峰>现价×1.05+20日涨>15%，上方套牢重（参考级，不计入共振）| WARNING | B |`;
...
## 你的专属技术规则库
- **RSI超卖**：RSI(6)<20，且非强下行趋势(MA20下行+破MA20) → 超卖/买入信号（R12，A级信号；底背离已移除，底部由R11止跌企稳覆盖）
- **箱体信号**：40日箱体突破>3%+放量，或60日箱体放量小阳吸筹 → 趋势启动信号（R15，B级）
- **离场阶梯**：破趋势线/破五日线/放量离场/缩量破位/急跌/5/10死叉/5/13死叉等破位离场信号合并阶梯，择优返回一条，死叉清仓覆盖前序减仓 → 硬止损信号必须提醒（R04，A级）
- **均线多头排列**：MA5>MA13>MA55+站上55日线且刚形成 → 多头格局确立（R16，B级）
- **站稳五日线加仓**：连续3日收盘站上MA5+MA5上行+站稳刚形成 → 强势确立加仓信号（R17，B级）
...
- **趋势底线**：离场阶梯(R04)触发死叉清仓档 或跌破55日线(R05)→趋势转弱，不抢反弹；5/13金叉(R10)放量+站上55日线才是有效买点。
...
- 如果 R04 离场阶梯 触发清仓档（急跌/5/10或5/13死叉/破趋势线+破MA60） 或 R05 跌破55日线 → 趋势转弱，建议谨慎，仓位降低。但不一定为0——需结合 RPS 强度、基本面、资金面综合判断。RPS≥90 且业绩高增的强势股回调破位时，可给"逢低关注"而非"清仓"
- 如果 R04 离场阶梯 仅触发减仓档（MA5拐头/跌破5日线/有效跌破10日线/放量离场） → 偏谨慎，但不绝对禁止看多（需看放量是出货还是洗盘）
- 强烈看多时仓位最高给到 1/2（仅限主线确认），温和看多时控制在 1/3 以内
- **强确认档**：若多重买入类硬信号共振（规则引擎中 R10/R13/R14/R15/R17 等≥2 条触发），按"强烈看多"处理，仓位可至 1/2；仅单一信号触发仍按温和看多≤1/3
