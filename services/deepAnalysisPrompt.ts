...
|----|------|------|------|--------|
| R02 | 见顶阶梯 | 对子顶/巨量见顶/第二波见顶/长上影/跳空衰竭/纺锤线/长下影见顶/连阳过热/连2天大涨/超大阳线/巨量异动，按严重度择优，extraData列全部命中子信号 | CRITICAL | A |
...
引擎初判（参考，11条规则检测结果）：${engineResults}`;
}
...
- 用第一人称："我发现"、"我认为"
- 如果有技术规则触发（RSI底部/箱体信号/离场阶梯/多头排列等），必须提及
