...
- **MA60 压制**：标的近60日涨幅≥30%且现价逼近 MA60 时，短期冲高回落风险偏高，注意提示（参考级）
- **箱体信号**：40日箱体突破>3%+放量，或60日箱体放量小阳吸筹 → 趋势启动信号（R10，A级）
- **离场阶梯**：急跌/5/10死叉/5/13死叉/破趋势线/破均线等破位离场信号合并阶梯，按严重度择优返回一条 → 强卖出信号必须提醒（R02，A级）
- **均线多头排列**：MA5>MA10>MA13+站上55日线且刚形成 → 多头格局确立（R11，参考级）
- **站稳五日线**：连续3日收盘站上MA5+MA5上行+站稳刚形成 → 强势确立信号（R12，B级）
...
- 用第一人称："我发现"、"我认为"
- 如果有技术规则触发（RSI超卖/箱体信号/离场阶梯/多头排列/站稳五日线等），必须提及
